...
<div class="form-group row">
    <label for="group" class="col-md-4 col-form-label text-md-right">{{ __('Student') }}</label>
    <div class="col-md-6">
        {{ Form::select('student_id', $studentsList, null, [
            'class' => ($errors->has('student_id') ? ' is-invalid ' : '') . 'form-control',
